      ...
      programs.television = {
        ...
        themes = {
          matugen = {
            ...
            dimmed_text_fg = c "outline_variant" "white";
            input_text_fg = c "on_surface" "bright-red";
            match_fg = c "primary" "bright-red";
            preview_title_fg = c "primary" "bright-magenta";
            remote_control_mode_bg = c "error" "yellow";
            remote_control_mode_fg = c "on_error" "black";
            result_count_fg = c "outline" "bright-red";
            result_line_number_fg = c "outline_variant" "bright-yellow";
            result_name_fg = c "on_surface" "bright-blue";
            result_value_fg = c "on_surface_variant" "white";
            selection_bg = c "surface_container_high" "bright-black";
            selection_fg = c "on_surface" "bright-green";
