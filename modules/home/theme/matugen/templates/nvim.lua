...
if ok then
	...
	local bg_alt = "{{colors.surface_container_low.default.hex}}"
	local bg_sel = "{{colors.surface_container_lowest.default.hex}}"
	...
	local green = "{{colors.primary.default.hex}}"
	local yellow = "{{colors.secondary.default.hex}}"
	local red = "{{colors.tertiary.default.hex}}"
