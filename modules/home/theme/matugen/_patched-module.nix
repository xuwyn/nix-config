# This is a local copy of  matugen.nixosModules.default as a workaround for IFD
# All credit belongs to the original creator/owner of this module
#
# Source   : github.com/InioX/matugen
# Link     : https://github.com/InioX/matugen/blob/133e410751c7c484a9fdddc299851d4494e59871/module.nix
# Changes  : Add cachedThemeFile option to avoid using IFD for `colors`
#            cachedThemeFile read a locally generated color file so
#            `colors` doesn't have to read a file generated at eval time
# Date     : 2026/08/13
#
#
...
matugen: {
  ...
  # Refactor to accept cachedThemeFile as an alternative (2026-08-13)
  colors =
    if cfg.cachedThemeFile != null
    then (builtins.fromJSON (builtins.readFile cfg.cachedThemeFile)).colors
    else (builtins.fromJSON (builtins.readFile "${themePackage}/theme.json")).colors;
in {
  options.programs.matugen = {
    enable = lib.mkEnableOption "Matugen declarative theming";

    # Add as an alternative to IFD for colors (2026-08-13)
    cachedThemeFile = lib.mkOption {
      type = lib.types.nullOr lib.types.path;
      default = null;
      description = "Path to a pre-generated theme.json to use instead of reading themePackage at eval time (IFD)";
    };
